...
export const aiConfig = registerAs('ai', () => ({
  ...
  baseUrl: process.env.AI_BASE_URL ?? process.env.ANTHROPIC_BASE_URL ?? AI_DEFAULTS.baseUrl,
  apiVersion: process.env.AI_API_VERSION ?? process.env.ANTHROPIC_API_VERSION ?? AI_DEFAULTS.apiVersion,
