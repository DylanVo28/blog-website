...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "surface-panel fixed left-1/2 top-1/2 z-50 grid w-[min(92vw,36rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[2rem] border border-border/70 p-6 shadow-[0_30px_90px_-48px_rgba(25,32,56,0.42)]",
        className,
      )}
      {...props}
    >
