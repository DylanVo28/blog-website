    ...
    <Card className="paper-grid overflow-hidden">
      <CardHeader className="gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          <div className="surface-panel inline-flex items-center gap-2 rounded-full border border-border/70 bg-[color-mix(in_oklab,var(--color-card)_84%,transparent)] px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-primary/75">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="surface-panel rounded-[1.2rem] border border-border/70 bg-[linear-gradient(180deg,color-mix(in_oklab,var(--color-card)_88%,transparent),color-mix(in_oklab,var(--color-card)_74%,var(--color-accent)_26%))] px-4 py-3">
          ...
          <div className="surface-panel inline-flex rounded-full border border-border/70 bg-[color-mix(in_oklab,var(--color-card)_84%,transparent)] p-1">
            {ranges.map((range) => (
              <button
                key={range}
                type="button"
      ...
      <CardContent className="space-y-4">
        <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
          <div className="surface-panel h-[320px] rounded-[1.5rem] border border-border/70 bg-[linear-gradient(180deg,color-mix(in_oklab,var(--color-card)_88%,transparent),color-mix(in_oklab,var(--color-card)_74%,var(--color-accent)_26%))] p-4">
            {isLoading ? (
